...
mix_wls = {
   'mix1' : ['gobmk',    'milc',       'cactusADM',   'lbm',        'gromacs',  'soplex',     'lbm',         'milc'],
   'mix2' : ['hmmer',    'cactusADM',  'milc',        'sjeng',      'gobmk',    'milc',       'cactusADM',   'lbm'],
   'mix3' : ['gobmk',    'perlbench',  'soplex',      'cactusADM',  'hmmer',    'cactusADM',  'milc',        'sjeng'],
   'mix4' : ['gobmk',    'sjeng',      'gcc',         'bzip2',      'libquantum',    'perlbench',  'soplex',      'cactusADM'],
   'mix5' : ['sjeng',    'hmmer',      'cactusADM',   'bzip2',      'gobmk',    'lbm',      'gcc',         'bzip2'],
   'mix6' : ['lbm',      'sphinx3',    'gobmk',       'hmmer',      'sjeng',    'hmmer',      'cactusADM',   'bzip2'],
   'mix7' : ['bzip2',    'lbm',        'libquantum',  'perlbench',  'lbm',      'sphinx3',    'gobmk',       'hmmer'],
   'mix8' : ['gromacs',  'gobmk',      'h264ref',     'hmmer',      'bzip2',    'lbm',        'libquantum',  'perlbench'],
   'mix9' : ['gromacs',  'h264ref',    'lbm',         'perlbench',  'gromacs',  'gobmk',      'h264ref',     'hmmer'],
   'mix10': ['bzip2',    'perlbench',  'gobmk',       'soplex',     'gromacs',  'h264ref',    'lbm',         'perlbench'],
   'mix11': ['milc',     'sphinx3',    'gcc',         'lbm',        'bzip2',    'perlbench',  'gobmk',       'soplex'],
   'mix12': ['milc',     'lbm',        'h264ref',     'hmmer',      'milc',     'sphinx3',    'gcc',         'lbm'],
   'mix13': ['sjeng',    'sphinx3',    'lbm',         'h264ref',    'milc',     'lbm',        'h264ref',     'hmmer'],
   'mix14': ['gromacs',  'soplex',     'lbm',         'milc',       'sjeng',    'sphinx3',    'lbm',         'h264ref']
}
